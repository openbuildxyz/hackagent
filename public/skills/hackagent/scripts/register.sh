...
# Usage: ./register.sh <eventId> <team_name> <email> <developer_github_url>
EVENT_ID=$1
TEAM_NAME=$2
EMAIL=$3
DEVELOPER_GITHUB_URL=$4
...
RESPONSE=$(curl -s -X POST "https://hackagent.vercel.app/api/v1/events/$EVENT_ID/register" \
  ...
  -d "{\"team_name\":\"$TEAM_NAME\",\"contact_email\":\"$EMAIL\",\"github_url\":\"$DEVELOPER_GITHUB_URL\",\"fields\":{}}")
